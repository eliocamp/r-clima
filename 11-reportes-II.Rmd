...
Si recordas lo que vimos en la sección de [reportes I](10-reportes-I.html) mencionamos que un chunk tiene una pinta como esta:
...
<div class="btn-group" role="group" aria-label="Navegación">
  <a href= "10-ggplot-III.html" class = "btn btn-primary">Anterior</a>
