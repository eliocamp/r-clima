...
1. ponerle "index.Rmd" al archivo de R Markdon y knitear como siempre
2. que tu archivo Rmd tenga el nombre que sea, knitar como siempre y luego ir y renombrar el archivo de salida como "index.html"
...
2. Abrí el archivo index.Rmd convertila en una página de inicio con vínculos a los archivos html que creaste y kniteálo para obtener el archivo index.html
